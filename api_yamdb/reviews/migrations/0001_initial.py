# Generated by Django 3.2 on 2022-12-29 02:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('user', 'Пользователь'), ('moderator', 'Модератор'), ('admin', 'Админ')], default='user', max_length=12, verbose_name='роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[reviews.validators.validate_year], verbose_name='Год производства')),
                ('raiting', models.IntegerField(blank=True, null=True, verbose_name='Рейтинг')),
